        ...
        <div className="flex flex-col gap-4 min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
            ...
            <div className="grid grid-cols-2 gap-4 bg-amber-900">
                <div className='flex flex-col gap-4'>
                    <Image src="/jones.png" alt="a file" width={205} height={0} />
                    <button className='bg-amber-600 text-black py-2 px-4'>Bota na tela Maquixueu</button>
                </div>
                <div className='flex flex-col gap-4'>
                    <Image src="/jones.png" alt="a file" width={205} height={0} />
                    <button className='bg-amber-600 text-black py-2 px-4'>Bota na tela Maquixueu</button>
            ...
            <div class="w-200 py-6 px-8 bg-gray-800 rounded-xl">
